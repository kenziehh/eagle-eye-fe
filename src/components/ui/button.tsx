  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive cursor-pointer",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-gradient-start bg-transparent shadow-xs hover:bg-gradient hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50",
        secondary:
      ...
      size: {
        default: "h-12 px-3 md:px-12 py-3 rounded-[40px] text-sm md:text-lg 2xl:text-2xl font-normal md:font-semibold ",
        sm: "h-8 rounded-md gap-1.5 px-3 has-[>svg]:px-2.5 text-xs md:text-lg font-normal ",
        lg: "h-10 rounded-md px-6 has-[>svg]:px-4 font-normal md:font-semibold ",
        icon: "size-9",
      },
    },
    defaultVariants: {
